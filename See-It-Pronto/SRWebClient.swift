...
open class SRWebClient : NSObject{
    ...
    *  GET class methods
    */
    open class func GET(_ url: String) -> SRWebClient {
        return SRWebClient(method: "GET", url: url)
    }
    
    open class func GET(_ url: String, success:SuccessHandler?, failure:FailureHandler?) -> SRWebClient {
        return SRWebClient.GET(url).send(success, failure: failure)
    }
    
    open class func GET(_ url: String, data:RequestData?, headers:Headers?) -> SRWebClient {
        return SRWebClient.GET(url).headers(headers).data(data)
    }
    
    open class func GET(_ url: String, data:RequestData?, success:SuccessHandler?, failure:FailureHandler?) -> SRWebClient {
        return SRWebClient.GET(url, data: data, headers:nil).send(success, failure: failure)
    }
    
    open class func GET(_ url: String, data:RequestData?, headers:Headers?, success:SuccessHandler?, failure:FailureHandler?) -> SRWebClient {
    ...
    *  POST class methods
    */
    open class func POST(_ url: String) -> SRWebClient {
        return SRWebClient(method: "POST", url: url)
    }
    
    open class func POST(_ url: String, success:SuccessHandler?, failure:FailureHandler?) -> SRWebClient {
        return SRWebClient.POST(url).send(success, failure: failure)
    }
    
    open class func POST(_ url: String, data:RequestData?, headers:Headers?) -> SRWebClient {
        return SRWebClient.POST(url).headers(headers).data(data)
    }
    
    open class func POST(_ url: String, data:RequestData?, success:SuccessHandler?, failure:FailureHandler?) -> SRWebClient {
        return SRWebClient.POST(url, data: data, headers:nil).send(success, failure: failure)
    }
    
    open class func POST(_ url: String, data:RequestData?, headers:Headers?, success:SuccessHandler?, failure:FailureHandler?) -> SRWebClient {
    ...
    */
    open func headers(_ headers: Headers?) -> SRWebClient {
        if (headers != nil) {
    ...
    */
    func build(_ dataDict:RequestData?) -> String? {
        ...
        return dataList.joined(separator: "&").addingPercentEncoding(withAllowedCharacters: .urlHostAllowed)
    }
    ...
    *  @return self instance to support function chaining
    */
    open func data(_ data:RequestData?) -> SRWebClient {
